...
const DICT: Record<Lang, Record<string, string>> = {
  pl: {
    ...
    "note.passChanged": "Hasło zmienione. Możesz korzystać z aplikacji.",
    "divider.or": "albo",
  ...
  en: {
    ...
    "note.passChanged": "Password changed. You can use the app now.",
    "divider.or": "or",
  ...
  de: {
    ...
    "note.passChanged": "Passwort geändert. Du kannst die App jetzt nutzen.",
    "divider.or": "oder",
