...
const DICT: Record<Lang, Record<string, string>> = {
  pl: {
    ...
    "note.registerSent": "Sprawdź skrzynkę — wysłaliśmy link potwierdzający na {email}. Po potwierdzeniu wróć tutaj i zaloguj się (potem możesz włączyć Face ID).",
  ...
  en: {
    ...
    "note.registerSent": "Check your inbox — we sent a confirmation link to {email}. After confirming, come back here and sign in (then you can enable Face ID).",
  ...
  de: {
    ...
    "note.registerSent": "Prüfe dein Postfach — wir haben einen Bestätigungslink an {email} gesendet. Nach der Bestätigung komm zurück und melde dich an (danach kannst du Face ID aktivieren).",
